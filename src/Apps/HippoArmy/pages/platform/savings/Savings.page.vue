...
import { useStats, useTopUsers } from "@HA/queries/savings";
...
<template>
  <div class="dashboard">
    <DashboardHeader
      ...
      title="Savings"
      description="scrvUSD savings metrics including APR, TVL, events and volume"
    />

    <KPI
      style="grid-area: kpi1"
      label="APY (Current)"
      :has-value="stats?.currentApr !== undefined"
    >
      <AsyncValue
        type="percentage"
        :value="stats?.currentApr ?? null"
      />
    </KPI>
