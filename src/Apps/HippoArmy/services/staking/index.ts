...
export async function getEvents(
  ...
  const data = await fetch(
    `${host}/v1/staking/${chain}/events${queryString}`,
    undefined,
    options?.signal
  );
...
export async function getCooldownQueue(
  ...
  const data = await fetch(
    `${host}/v1/staking/${chain}/cooldown_queue`,
    undefined,
    options?.signal
  );
...
export async function getAprHistory(
  ...
  const data = await fetch(
    `${host}/v1/staking/${chain}/apr_history${queryString}`,
    undefined,
    options?.signal
  );
...
export async function getTvlHistory(
  ...
  const data = await fetch(
    `${host}/v1/staking/${chain}/tvl_history${queryString}`,
    undefined,
    options?.signal
  );
...
export async function getTopUsers(
  ...
  const data = await fetch(
    `${host}/v1/staking/${chain}/top_users`,
    undefined,
    options?.signal
  );
...
export async function getPositionHist(
  ...
  const data = await fetch(
    `${host}/v1/staking/${chain}/position_histogram${queryString}`,
    undefined,
    options?.signal
  );
