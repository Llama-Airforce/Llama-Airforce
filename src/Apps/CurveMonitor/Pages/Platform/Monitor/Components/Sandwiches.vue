...
import {
  ...
  type SandwichDetail,
} from "@CM/Services/Monitor/MEV";
import { useQuerySandwichesRx } from "@CM/Services/Monitor/MEV/Queries";
...
const page = ref(1);
const { data: sandwichesRaw, isFetching: loading } = useQuerySandwichesRx();
