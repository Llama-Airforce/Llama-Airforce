...
export interface CurveV6FactoryPoolInterface extends utils.Interface {
  functions: {
...
export interface CurveV6FactoryPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveV6FactoryPoolInterface;
